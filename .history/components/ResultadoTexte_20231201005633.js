...
const ResultadoTexte = () => {
  ...
  //     return null; // Retorna null se a altura for 50
  //   } else {
  //     const bolhasFaltando = 15 - chosenNumbers.length;
  ...
  //             }}
  //           >
  //             Você selecionou {bolhasSelecionadas} bolhas
  //           </Text>
  //         </View>
  //         <View style={bolhasContainerStyle}>
  //           {dezenasParaEscolher.map((numero, index) => (
  ...
  //   const [chosenNumbers, setChosenNumbers] = useState([]);
  //   const bolhasSelecionadas = chosenNumbers.length;
  //   const bolhasRestantes = 15 - bolhasSelecionadas;
      ...
      return (
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          ...
          <View key="números" style={{}}>
            ...
            >
              {bolhasSelecionadas} bolhas selecionadas
            </Text>
          </View>
        </View>
      );
